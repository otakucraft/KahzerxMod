...
//                        server.getPlayerManager().broadcast(Text.translatable("multiplayer.player.joined", new Object[]{player.getDisplayName()}).formatted(Formatting.YELLOW), MessageType.SYSTEM);
                        server.getPlayerManager().broadcast(Text.translatable("multiplayer.player.left", new Object[]{player.getDisplayName()}).formatted(Formatting.YELLOW), MessageType.SYSTEM);
                    }
                    return 1;
                }));
    }
